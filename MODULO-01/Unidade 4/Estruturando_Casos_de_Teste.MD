...
**Passos:**
- P1 - Informar usuário não cadastrado
- P2 - Informar qualquer senha
- P3 - Clicar no botão Entrar
...
**Pré-condições:** Nenhuma.  
**Passos:**
- P1 - Deixar o campo de usuário em branco
- P2 - Informar senha válida
- P3 - Clicar no botão Entrar
...
**Passos:**
- P1 - Informar usuário válido
- P2 - Deixar o campo de senha em branco
- P3 - Clicar no botão Entrar
...
**Passos:**
- P1 - Informar usuário válido
- P2 - Informar senha incorreta repetidamente até o limite permitido
- P3 - Tentar logar novamente com a senha correta
...
**Passos:**
- P1 - Informar usuário válido
- P2 - Informar a senha correta trocando maiúsculas por minúsculas
- P3 - Clicar no botão Entrar
...
**Pré-condições:** Ter um usuário cadastrado no sistema.  
**Passos:**
- P1 - Colar o usuário válido com espaços em branco antes e depois
- P2 - Informar senha válida
- P3 - Clicar no botão Entrar
...
**Passos:**
- P1 - Digitar uma senha
- P2 - Clicar no ícone de mostrar senha
